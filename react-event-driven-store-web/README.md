...
```sh
npx nx serve react-event-driven-store-web
```

To create a production bundle:

```sh
npx nx build react-event-driven-store-web
```

To see all available targets to run for a project, run:

```sh
npx nx show project react-event-driven-store-web
```
